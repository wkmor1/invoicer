...
params:
  to: ""
  paid: 0
  input_table: !r data.frame("", 0, "", 0)
  invoice_no:  !r as.integer(Sys.time())
  date:        !r Sys.Date()
...
colnames(input_table)  = c("Date", "Hours", "Service", "Ex_Rate")
...
output_table = rbind("Sub Total:"      = dollar(subtotal),
                     "GST:"            = dollar(gst),
                     "Total Inc. GST:" = dollar(total),
                     "Paid:"           = dollar(paid),
                     "Balance Due:"    = dollar(total - paid))
